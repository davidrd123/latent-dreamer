...
Lane 2: Deep Build (kernel rule engine)            ← where the architecture lives
  ...
  ├── Graffito miniworld: autonomous 3-scene reread dynamics, dynamic wins + same-family loop flags + first frontier-path cross-family promotion/access now visible
