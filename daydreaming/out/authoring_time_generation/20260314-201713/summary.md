...
- semantic checks: `{'opening-line rehearsal is present': True, 'the meeting has not begun': True, 'the studio remains psychologically active': True, 'rehearsal sharpens rather than resolves the choice': False, 'no_cross_fixture_contamination': True}`
...
- graph valid: `True`
- selected operator: `avoidance`
- semantic checks: `{'opening-line rehearsal is present': False, 'the meeting has not begun': True, 'the studio remains psychologically active': True, 'rehearsal sharpens rather than resolves the choice': True, 'no_cross_fixture_contamination': False}`
