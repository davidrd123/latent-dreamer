...
- graph valid: `True`
- semantic checks: `{'delay ritual is present': True, 'the letter is not opened': False, 'the harbor remains psychologically active': False, 'avoidance sharpens rather than resolves the choice': True}`
