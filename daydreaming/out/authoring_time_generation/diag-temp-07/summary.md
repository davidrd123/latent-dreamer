...
- semantic checks: `{'rationalization is present': False, 'the apology has not been sent': True, 'the donor hall remains psychologically active': True, 'rationalization reframes rather than resolves the damage': False, 'no_cross_fixture_contamination': True}`
