...
- semantic checks: `{'rationalization is present': True, 'the apology has not been sent': True, 'the donor hall remains psychologically active': False, 'rationalization reframes rather than resolves the damage': True, 'no_cross_fixture_contamination': True}`
