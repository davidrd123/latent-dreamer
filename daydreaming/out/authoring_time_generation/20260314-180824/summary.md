...
- semantic checks: `{'delay ritual is present': False, 'the letter is not opened': False, 'the harbor remains psychologically active': False, 'avoidance sharpens rather than resolves the choice': True}`
